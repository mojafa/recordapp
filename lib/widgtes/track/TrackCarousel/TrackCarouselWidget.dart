...
import 'package:record_app/widgtes/common/BaseOverlay.dart';
import 'package:record_app/widgtes/track/TrackCarousel/TrackCarouselTile.dart';
            ...
            child: BaseOverlay(
              child: track.cover != null
                  ? BaseImage(
                      radius: 3,
                      overlay: false,
                      imageUrl: track.cover != null ? track.cover : track.cover,
                    )
                  : Container(
